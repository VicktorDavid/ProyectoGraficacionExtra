...
document.getElementById('abrirTodos').addEventListener('click', abrirTodos, false);
document.getElementById('cerrarTodos').addEventListener('click', CerrarTodos, false);
